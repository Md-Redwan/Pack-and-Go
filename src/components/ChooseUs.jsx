...
import SelectedDestinationImg3 from "../assets/SelectedDestinationImg3.png";
    ...
    <div className="container pt-37.5 font-poppins">
      ...
      <div className="flex flex-col-reverse lg:flex-row justify-between items-center">
        <div className="w-auto lg:w-[40%]">
          ...
          <p className="text-secondary leading-7.5 mt-5 mb-10 text-center lg:text-left">
            You can choose one of many option that we have on our website. Every
            destination have been 4+ star rated by our user before. You can
            search by clicking our button on below of the this text man.
          </p>
      ...
      <div className="container flex-col gap-10 lg:gap-0 lg:flex-row flex lg:justify-between lg:items-center pt-22 lg:pt-17.5">
        ...
        <div className="w-auto lg:w-[50%] flex flex-col items-end text-start">
          <h2 className="font-semibold lg:w-130 w-auto text-[30px] md:text-[35px] lg:text-[40px] text-center lg:text-start">
            Always give you promo on every Month / Event
          </h2>
          <p className="lg:w-130 w-auto leading-7.5 text-secondary my-5 text-center lg:text-start">
            We make sure give you a lot of promo every motnh or event based on
            calendar. If you want, just Subscribe on Newsletter.
          </p>
      ...
      {/* Money Back Guarantee Part is start */}
      <div className="flex flex-col-reverse lg:flex-row justify-between items-center lg:items-start gap-10 pt-22 lg:pt-17.5">
        <div className="w-auto lg:w-[40%]">
          <h2 className="font-semibold text-[30px] md:text-[35px] lg:text-[40px] text-center lg:text-start">
            100% Money back Guarantee If you Cancel
          </h2>
          <p className="text-secondary leading-7.5 mt-5 mb-10 text-center lg:text-left">
            We Promises in this case. We still want to refund your money when
            you cancel order.
          </p>
          ...
          <Accordion collapseAll>
            <AccordionPanel>
              <AccordionTitle>Friendly, Quick, Easy</AccordionTitle>
              <AccordionContent>
                <p className="mb-2 text-gray-500 dark:text-gray-400">
                  Business messaging that feels just like the messenger apps you and your customers use every day.
                </p>
                
              </AccordionContent>
            </AccordionPanel>
            <AccordionPanel>
              <AccordionTitle>Fast Response Answer </AccordionTitle>
              <AccordionContent>
                <p className="mb-2 text-gray-500 dark:text-gray-400">
                  Business messaging that feels just like the messenger apps you and your customers use every day.
                </p>
        ...
        <div className="w-auto lg:w-[40%]">
          <img src={SelectedDestinationImg3} alt="" />
        </div>
      </div>
      {/* Money Back Guarantee Part is end */}
    </div>
  );
};
